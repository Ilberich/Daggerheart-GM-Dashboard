...
function toggleLoreMenu(e){
  ...
  if(m.style.display==='none'){
    var btn=document.getElementById('lore-add-btn');
    var r=btn.getBoundingClientRect();
    var right=window.innerWidth-r.right;
    var minWidth=parseInt(getComputedStyle(m).minWidth)||170;
    right=Math.min(right,window.innerWidth-minWidth);
...
const ADV=[
  ...
  {id:'skeleton-dredge',tier:1,name:'Skeleton Dredge',type:'minion',dc:8,hp:1,st:1,maj:null,sev:null,atk:'−1',wpn:'Bone Claws · Melee',dmg:'1 phy',motives:'Fall apart, overwhelm, play dead',feats:[{k:P,n:'Minion (4)',d:'Defeated when they take any damage. For every 4 damage dealt, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to spotlight all Dredges within Close of a target. Move into Melee, one shared attack. On a success, deal 1 phy each — combine.'}]},
  {id:'tangle-bramble',tier:1,name:'Tangle Bramble',type:'minion',dc:11,hp:1,st:1,maj:null,sev:null,atk:'−1',wpn:'Thorns · Melee',dmg:'2 phy',motives:'Combine, drain, entangle',feats:[{k:P,n:'Minion (4)',d:'Defeated when they take any damage. For every 4 damage dealt, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to spotlight all Tangle Brambles within Close of a target. Move into Melee, one shared attack. On a success, deal 2 phy each — combine.'},{k:R,n:'Drain and Multiply',d:"When an attack causes a target to mark HP and there are 3+ Tangle Bramble Minions within Close range, combine them into a Tangle Bramble Swarm Horde. The Horde's HP = number of Minions combined."}]},
  {id:'jk-hexer',tier:1,name:'Jagged Knife Hexer',type:'support',dc:13,hp:4,st:4,maj:5,sev:9,atk:'+2',wpn:'Staff · Far',dmg:'1d6+2 mag',motives:'Command, hex, profit',feats:[{k:A,n:'Curse',d:'Choose a target within Far and temporarily Curse them. While Cursed, mark a Stress when that target rolls with Hope to make the roll be with Fear instead.'},{k:A,n:'Chaotic Flux',d:'Attack up to three targets within Very Close. Mark a Stress to deal 2d6+3 mag to any the Hexer succeeded against.'}]},
  {id:'courtier',tier:1,name:'Courtier',type:'social',dc:12,hp:3,st:4,maj:4,sev:8,atk:'−4',wpn:'Daggers · Melee',dmg:'1d4+2 phy',motives:'Discredit, gain favor, maneuver, scheme',feats:[{k:A,n:'Mockery',d:'Mark a Stress to say something mocking and force a target within Close to make a Presence Reaction Roll (14). Fail = mark 2 Stress and become Vulnerable until the scene ends.'},{k:A,n:'Scapegoat',d:'Spend a Fear and target a PC. The Courtier convinces a crowd or prominent individual that the target is the cause of their current conflict or misfortune.'}]},
  {id:'merchant',tier:1,name:'Merchant',type:'social',dc:12,hp:3,st:3,maj:4,sev:8,atk:'−4',wpn:'Club · Melee',dmg:'1d4+1 phy',motives:'Buy low and sell high, create demand, inflate prices',feats:[{k:P,n:'Preferential Treatment',d:'A PC who succeeds on a Presence Roll against the Merchant gains a discount on purchases. A PC who fails must pay more and has disadvantage on future Presence Rolls against the Merchant.'},{k:P,n:'The Runaround',d:'When a PC rolls a 14 or lower on a Presence Roll against the Merchant, they must mark a Stress.'}]},
  {id:'petty-noble',tier:1,name:'Petty Noble',type:'social',dc:14,hp:3,st:5,maj:6,sev:10,atk:'−3',wpn:'Rapier · Melee',dmg:'1d6+1 phy',motives:'Abuse power, gather resources, mobilize minions',feats:[{k:P,n:'My Land, My Rules',d:'All social actions made against the Noble on their own land have disadvantage.'},{k:A,n:'Guards, Seize Them!',d:'Once per scene, mark a Stress to summon 1d4 Bladed Guards, who appear at Far range.'},{k:A,n:'Exile',d:'Spend a Fear and target a PC. The Noble proclaims the target and their allies exiled from their territory. While exiled, all have disadvantage during social situations within the Noble\'s domain.'}]},
  // ── Tier 2 ──────────────────────────────────────────────────────────────
  {id:'archer-squadron',tier:2,name:'Archer Squadron',type:'horde',dc:13,hp:4,st:3,maj:8,sev:16,atk:'+0',wpn:'Longbow · Far',dmg:'2d6+3 phy',motives:'Stick together, survive, volley fire',feats:[{k:P,n:'Horde (1d6+3)',d:'When the Squadron has marked half or more of their HP, their standard attack deals 1d6+3 phy instead.'},{k:A,n:'Focused Volley',d:'Spend a Fear to target a point within Far range. Make an attack with advantage against all targets within Close of that point. Targets hit take 1d10+4 phy.'},{k:A,n:'Suppressing Fire',d:'Mark a Stress to target a point within Far range. Until the next roll with Fear, a creature who moves within Close of that point must make an Agility Reaction Roll. On a failure, take 2d6+3 phy. On a success, take half damage.'}]},
  {id:'apprentice-assassin',tier:2,name:'Apprentice Assassin',type:'minion',dc:13,hp:1,st:1,maj:null,sev:null,atk:'−1',wpn:'Thrown Dagger · Very Close',dmg:'4 phy',motives:'Act reckless, kill, prove their worth, show off',feats:[{k:P,n:'Minion (6)',d:'The Assassin is defeated when they take any damage. For every 6 damage a PC deals to the Assassin, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Apprentice Assassins within Close range of them. Those Minions move into Melee range and make one shared attack roll. On a success, they deal 4 phy each. Combine this damage.'}]},
  {id:'assassin-poisoner',tier:2,name:'Assassin Poisoner',type:'skulk',dc:14,hp:4,st:4,maj:8,sev:16,atk:'+3',wpn:'Poisoned Throwing Dagger · Close',dmg:'2d8+1 phy',motives:'Anticipate, get paid, kill, taint food and water',feats:[{k:P,n:'Grindletooth Venom',d:'Targets who mark HP from the Assassin\'s attacks are Vulnerable until they clear a HP.'},{k:P,n:'Out of Nowhere',d:'The Assassin has advantage on attacks if they are Hidden.'},{k:A,n:'Fumigation',d:'Drop a smoke bomb that fills the air within Close range with smoke, Dizzying all targets in this area. Dizzied targets have disadvantage on their next action roll, then clear the condition.'}]},
  {id:'master-assassin',tier:2,name:'Master Assassin',type:'leader',dc:15,hp:7,st:5,maj:12,sev:25,atk:'+5',wpn:'Serrated Dagger · Close',dmg:'2d10+2 phy',motives:'Ambush, get out alive, kill, prepare for all scenarios',feats:[{k:P,n:"Won't See It Coming",d:'The Assassin deals direct damage while they\'re Hidden.'},{k:A,n:'Strike as One',d:"Mark a Stress to spotlight a number of other Assassins equal to the Assassin's unmarked Stress."},{k:R,n:'The Subtle Blade',d:'When the Assassin successfully makes a standard attack against a Vulnerable target, you can spend a Fear to deal Severe damage instead of standard.'},{k:R,n:'Momentum',d:'When the Assassin makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'battle-box',tier:2,name:'Battle Box',type:'solo',dc:15,hp:8,st:6,maj:10,sev:20,atk:'+2',wpn:'Slam · Melee',dmg:'2d6+3 phy',motives:'Change tactics, trample foes, wait in disguise',feats:[{k:P,n:'Relentless (2)',d:'The Box can be spotlighted up to two times per GM turn. Spend Fear as usual to spotlight them.'},{k:A,n:'Randomized Tactics',d:'Mark a Stress and roll a d6: 1. Mana Beam — attack within Far, 2d10+2 mag. 2. Fire Jets — attack all within Close, 2d8 phy. 3. Trample — attack all PCs within Close, 1d6+5 phy and Vulnerable. 4. Shocking Gas — all within Close Finesse Reaction or mark 3 Stress. 5. Stunning Clap — all within Very Close Strength Reaction or Vulnerable until defeated. 6. Psionic Whine — all within Close Presence Reaction or 2d4+9 direct mag.'},{k:R,n:'Overcharge',d:'Before rolling damage for the Box\'s attack, mark a Stress to add a d6 to the damage roll. Additionally, gain a Fear.'},{k:R,n:'Death Quake',d:'When the Box marks their last HP, all targets within Close must succeed on an Instinct Reaction Roll or take 2d8+1 mag.'}]},
  {id:'chaos-skull',tier:2,name:'Chaos Skull',type:'ranged',dc:15,hp:5,st:4,maj:8,sev:16,atk:'+2',wpn:'Energy Blast · Close',dmg:'2d8+3 mag',motives:'Cackle, consume magic, serve creator',feats:[{k:P,n:'Levitation',d:"The Skull levitates several feet off the ground and can't be Restrained."},{k:P,n:'Wards',d:'The Skull is resistant to magic damage.'},{k:A,n:'Magic Burst',d:'Mark a Stress to make an attack against all targets within Close range. Targets hit take 2d6+4 mag.'},{k:A,n:'Siphon Magic',d:'Spend a Fear to make an attack against a PC with a Spellcast trait within Very Close range. On a success, the target marks 1d4 Stress and the Skull clears that many Stress. Additionally, on a success, the Skull can immediately be spotlighted again.'}]},
  {id:'conscript',tier:2,name:'Conscript',type:'minion',dc:12,hp:1,st:1,maj:null,sev:null,atk:'+0',wpn:'Spears · Very Close',dmg:'6 phy',motives:'Follow orders, gang up, survive',feats:[{k:P,n:'Minion (6)',d:'The Conscript is defeated when they take any damage. For every 6 damage a PC deals to the Conscript, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Conscripts within Close range. Those Minions move into Melee and make one shared attack roll. On a success, deal 6 phy each. Combine this damage.'}]},
  {id:'courtesan',tier:2,name:'Courtesan',type:'social',dc:13,hp:3,st:4,maj:7,sev:13,atk:'−3',wpn:'Dagger · Melee',dmg:'1d4+3 phy',motives:'Entice, maneuver, secure patrons',feats:[{k:R,n:'Searing Glance',d:"When a PC within Close range makes a Presence Roll, mark a Stress to cast a gaze toward the aftermath. On the target's failure, they must mark 2 Stress and are Vulnerable until the scene ends or they succeed on a social action against the Courtesan. On the target's success, they must mark a Stress."}]},
  {id:'cult-adept',tier:2,name:'Cult Adept',type:'support',dc:14,hp:4,st:6,maj:9,sev:18,atk:'+2',wpn:'Rune-Covered Rod · Far',dmg:'2d4+3 mag',motives:'Curry favor, hinder foes, uncover knowledge',feats:[{k:A,n:'Enervating Blast',d:'Spend a Fear to make a standard attack against a target within range. On a success, the target must mark a Stress.'},{k:A,n:'Shroud of the Fallen',d:'Mark a Stress to wrap an ally within Close range in a shroud of Protection until the Adept marks their last HP. While Protected, the target has resistance to all damage.'},{k:A,n:'Shadow Shackles',d:'Spend a Fear and choose a point within Far range. All targets within Close of that point are Restrained in smoky chains until they break free with a Strength or Instinct Roll. A target Restrained by this feature must spend a Hope to make an action roll.'},{k:R,n:'Fear Is Fuel',d:'Twice per scene, when a PC rolls a failure with Fear, clear a Stress.'}]},
  {id:'cult-fang',tier:2,name:'Cult Fang',type:'skulk',dc:15,hp:4,st:4,maj:9,sev:17,atk:'+2',wpn:'Long Knife · Melee',dmg:'2d8+4 phy',motives:'Capture sacrifices, isolate prey, rise in the ranks',feats:[{k:P,n:"Shadow's Embrace",d:'The Fang can climb and walk on vertical surfaces. Mark a Stress to move from one shadow to another within Far range.'},{k:A,n:'Pick Off the Straggler',d:'Mark a Stress to cause a target within Melee range to make an Instinct Reaction Roll. On a failure, the target must mark 2 Stress and is teleported with the Fang to a shadow within Far range, making them temporarily Vulnerable. On a success, the target must mark a Stress.'}]},
  {id:'cult-initiate',tier:2,name:'Cult Initiate',type:'minion',dc:13,hp:1,st:1,maj:null,sev:null,atk:'+0',wpn:'Ritual Dagger · Melee',dmg:'5 phy',motives:'Follow orders, gain power, seek forbidden knowledge',feats:[{k:P,n:'Minion (6)',d:'The Initiate is defeated when they take any damage. For every 6 damage a PC deals to the Initiate, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Cult Initiates within Close range. Those Minions move into Melee and make one shared attack roll. On a success, deal 5 phy each. Combine this damage.'}]},
  {id:'demonic-hound-pack',tier:2,name:'Demonic Hound Pack',type:'horde',dc:15,hp:6,st:3,maj:11,sev:23,atk:'+0',wpn:'Claws and Fangs · Melee',dmg:'2d8+2 phy',motives:'Cause fear, consume flesh, please masters',feats:[{k:P,n:'Horde (2d4+1)',d:'When the Pack has marked half or more of their HP, their standard attack deals 2d4+1 phy instead.'},{k:A,n:'Dreadhowl',d:'Mark a Stress to make all targets within Very Close range lose a Hope. If a target is not able to lose a Hope, they must instead mark 2 Stress.'},{k:R,n:'Momentum',d:'When the Pack makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'electric-eels',tier:2,name:'Electric Eels',type:'horde',dc:14,hp:5,st:3,maj:10,sev:20,atk:'+0',wpn:'Shocking Bite · Melee',dmg:'2d6+4 phy',motives:'Avoid larger predators, shock prey, tear apart',feats:[{k:P,n:'Horde (2d4+1)',d:'When the Eels have marked half or more of their HP, their standard attack deals 2d4+1 phy instead.'},{k:A,n:'Paralyzing Shock',d:'Mark a Stress to make a standard attack against all targets within Very Close range. Gain a Fear for each target that marks HP.'}]},
  {id:'elite-soldier',tier:2,name:'Elite Soldier',type:'standard',dc:15,hp:4,st:3,maj:9,sev:18,atk:'+1',wpn:'Spear · Very Close',dmg:'2d8+4 phy',motives:'Gain glory, keep order, make alliances',feats:[{k:A,n:'Reinforce',d:'Mark a Stress to move into Melee of an ally and make a standard attack against a target within Very Close range. On a success, deal 2d10+2 phy and the ally can clear a Stress.'},{k:R,n:"Vassal's Loyalty",d:'When the Soldier is within Very Close range of a knight or other noble who would take damage, mark a Stress to move into Melee of them and take the damage instead.'}]},
  {id:'failed-experiment',tier:2,name:'Failed Experiment',type:'standard',dc:13,hp:3,st:3,maj:12,sev:23,atk:'+1',wpn:'Bite and Claw · Melee',dmg:'2d6+5 phy',motives:'Devour, hunt, track',feats:[{k:P,n:'Warped Fortitude',d:'The Experiment is resistant to physical damage.'},{k:P,n:'Overwhelm',d:'When a target the Experiment attacks has other adversaries within Very Close range, the Experiment deals double damage.'},{k:A,n:'Lurching Lunge',d:'Mark a Stress to spotlight the Experiment as an additional GM move instead of spending Fear.'}]},
  {id:'giant-beastmaster',tier:2,name:'Giant Beastmaster',type:'leader',dc:16,hp:6,st:5,maj:12,sev:24,atk:'+2',wpn:'Longbow · Far',dmg:'2d8+4 phy',motives:'Command, make a living, maneuver, pin down, protect companion animals',feats:[{k:P,n:'Two as One',d:'When the Beastmaster is spotlighted, you can also spotlight a Tier 1 animal adversary currently under their control.'},{k:A,n:'Pinning Strike',d:'Make a standard attack against a target. On a success, mark a Stress to pin them to a nearby surface. The pinned target is Restrained until they break free with a successful Finesse or Strength Roll.'},{k:A,n:'Deadly Companion',d:'Twice per scene, summon a Bear, Dire Wolf, or similar Tier 1 animal adversary under the Beastmaster\'s control. The adversary appears at Close range and is immediately spotlighted.'}]},
  {id:'giant-brawler',tier:2,name:'Giant Brawler',type:'bruiser',dc:15,hp:7,st:4,maj:14,sev:28,atk:'+2',wpn:'Warhammer · Very Close',dmg:'2d12+3 phy',motives:'Make a living, overwhelm, slam, topple',feats:[{k:A,n:'Battering Ram',d:'Mark a Stress to have the Brawler charge at an inanimate object within Close range they could feasibly smash and destroy it. All targets within Very Close of the object must succeed on an Agility Reaction Roll or take 2d4+3 phy from the shrapnel.'},{k:R,n:'Bloody Reprisal',d:'When the Brawler marks 2 or more HP from an attack within Very Close range, make a standard attack against the attacker. On a success, deal 2d6+15 phy instead of standard.'},{k:R,n:'Momentum',d:'When the Brawler makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'giant-recruit',tier:2,name:'Giant Recruit',type:'minion',dc:13,hp:1,st:2,maj:null,sev:null,atk:'+1',wpn:'Warhammer · Very Close',dmg:'5 phy',motives:'Batter, make a living, overwhelm, terrify',feats:[{k:P,n:'Minion (7)',d:'The Recruit is defeated when they take any damage. For every 7 damage a PC deals to the Recruit, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Giant Recruits within Close range. Those Minions move into Melee and make one shared attack roll. On a success, deal 5 phy each. Combine this damage.'}]},
  {id:'giant-eagle',tier:2,name:'Giant Eagle',type:'skulk',dc:14,hp:4,st:4,maj:8,sev:19,atk:'+1',wpn:'Claws and Beak · Very Close',dmg:'2d6+3 phy',motives:'Hunt prey, stay mobile, strike decisively',feats:[{k:P,n:'Flight',d:'While flying, the Eagle gains a +3 bonus to their Difficulty.'},{k:A,n:'Deadly Dive',d:'Mark a Stress to attack a target within Far range. On a success, deal 2d10+2 phy and knock the target over, making them Vulnerable until they next act.'},{k:A,n:'Take Off',d:'Make an attack against a target within Very Close. On a success, deal 2d4+3 phy and the target must succeed on an Agility Reaction Roll or become temporarily Restrained within the Eagle\'s talons. If Restrained, the Eagle lifts to Very Far range.'},{k:A,n:'Deadly Drop',d:'While flying, the Eagle can drop a Restrained target. When dropped, the target is no longer Restrained but starts falling. If their fall isn\'t prevented during the PCs\' next action, they take 2d20 phy when they land.'}]},
  {id:'gorgon',tier:2,name:'Gorgon',type:'solo',dc:15,hp:9,st:3,maj:13,sev:25,atk:'+4',wpn:'Sunsear Shortbow · Far',dmg:'2d20+3 mag',motives:'Corner, hit-and-run, petrify, seek vengeance',feats:[{k:P,n:'Relentless (2)',d:'The Gorgon can be spotlighted up to two times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Sunsear Arrows',d:"When the Gorgon makes a successful standard attack, the target Glows until the end of the scene and can't become Hidden. Attack rolls made against a Glowing target have advantage."},{k:A,n:'Crown of Serpents',d:'Make an attack roll against a target within Melee using the Gorgon\'s protective snakes. On a success, mark a Stress to deal 2d10+4 phy and the target must mark a Stress.'},{k:R,n:'Petrifying Gaze',d:'When the Gorgon takes damage from an attack within Close range, spend a Fear to force the attacker to make an Instinct Reaction Roll. On a failure, they begin to turn to stone, marking a HP and starting a Petrification Countdown (4). The countdown ticks when the Gorgon is attacked. When it triggers, the target must make a death move. If the Gorgon is defeated, all petrification countdowns end.'},{k:R,n:'Momentum',d:'When the Gorgon makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'juvenile-flickerfly',tier:2,name:'Juvenile Flickerfly',type:'solo',dc:14,hp:10,st:5,maj:13,sev:26,atk:'+3',wpn:'Wing Slash · Very Close',dmg:'2d10+4 phy',motives:'Collect shiny things, hunt, swoop',feats:[{k:P,n:'Relentless (3)',d:'The Flickerfly can be spotlighted up to three times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Peerless Accuracy',d:'Before the Flickerfly makes an attack, roll a d6. On a result of 4 or higher, the target\'s Evasion is halved against this attack.'},{k:A,n:'Mind Dance',d:'Mark a Stress to create a magically dazzling display that grapples the minds of nearby foes. All targets within Close must make an Instinct Reaction Roll. For each target who failed, gain a Fear and the Flickerfly learns one of their fears.'},{k:R,n:'Hallucinatory Breath',d:'Countdown (Loop 1d6). When the Flickerfly takes damage for the first time, activate the countdown. When it triggers, breathe hallucinatory gas on all targets in front within Far range. Targets must succeed on an Instinct Reaction Roll or be tormented by fearful hallucinations. Targets whose fears are known have disadvantage on this roll. Targets who fail mark a Stress and lose a Hope.'}]},
  {id:'knight-of-the-realm',tier:2,name:'Knight of the Realm',type:'leader',dc:15,hp:6,st:4,maj:13,sev:26,atk:'+4',wpn:'Longsword · Melee',dmg:'2d10+4 phy',motives:'Run down, seek glory, show dominance',feats:[{k:P,n:'Chevalier',d:'While the Knight is on a mount, they gain a +2 bonus to their Difficulty. When they take Severe damage, they\'re knocked from their mount and lose this benefit until they\'re next spotlighted.'},{k:P,n:'Heavily Armored',d:'When the Knight takes physical damage, reduce it by 3.'},{k:A,n:'Cavalry Charge',d:'If the Knight is mounted, move up to Far range and make a standard attack against a target. On a success, deal 2d8+4 phy and the target must mark a Stress.'},{k:A,n:'For the Realm!',d:'Mark a Stress to spotlight 1d4+1 allies. Attacks they make while spotlighted in this way deal half damage.'}]},
  {id:'masked-thief',tier:2,name:'Masked Thief',type:'skulk',dc:14,hp:4,st:5,maj:8,sev:17,atk:'+3',wpn:'Backsword · Melee',dmg:'2d8+3 phy',motives:'Evade, hide, pilfer, profit',feats:[{k:A,n:'Quick Hands',d:'Make an attack against a target within Melee. On a success, deal 1d8+2 phy and the Thief steals one item or consumable from the target\'s inventory.'},{k:A,n:'Escape Plan',d:'Mark a Stress to reveal a snare trap set anywhere on the battlefield. All targets within Very Close of the trap must succeed on an Agility Reaction Roll (13) or be pulled off their feet and suspended upside down. A target is Restrained and Vulnerable until they break free with a successful Finesse or Strength Roll (13).'}]},
  {id:'merchant-baron',tier:2,name:'Merchant Baron',type:'social',dc:15,hp:5,st:3,maj:9,sev:19,atk:'−2',wpn:'Rapier · Melee',dmg:'1d6+2 phy',motives:'Abuse power, gather resources, mobilize minions',feats:[{k:A,n:'Everyone Has a Price',d:'Spend a Fear to offer a target a dangerous bargain for something they want or need. If used on a PC, they must make a Presence Reaction Roll (17). On a failure, they must mark 2 Stress or take the deal.'},{k:A,n:'The Best Muscle Money Can Buy',d:'Once per scene, mark a Stress to summon 1d4+1 Tier 1 adversaries, who appear at Far range, to enforce the Baron\'s will.'}]},
  {id:'minotaur-wrecker',tier:2,name:'Minotaur Wrecker',type:'bruiser',dc:16,hp:7,st:5,maj:14,sev:27,atk:'+2',wpn:'Battleaxe · Very Close',dmg:'2d8+5 phy',motives:'Consume, gore, navigate, overpower, pursue',feats:[{k:P,n:'Ramp Up',d:'You must spend a Fear to spotlight the Minotaur. While spotlighted, they can make their standard attack against all targets within range.'},{k:A,n:'Charging Bull',d:'Mark a Stress to charge through a group within Close range and make an attack against all targets in the Minotaur\'s path. Targets hit take 2d6+8 phy and are knocked back to Very Far range. If knocked into a solid object or another creature, they take an extra 1d6 damage.'},{k:A,n:'Gore',d:'Make an attack against a target within Very Close, moving the Minotaur into Melee range. On a success, deal 2d8 direct phy.'}]},
  {id:'mortal-hunter',tier:2,name:'Mortal Hunter',type:'leader',dc:16,hp:6,st:4,maj:15,sev:27,atk:'+5',wpn:'Tear at Flesh · Very Close',dmg:'2d12+1 phy',motives:'Devour, hunt, track',feats:[{k:P,n:'Terrifying',d:'When the Hunter makes a successful attack, all PCs within Far range lose a Hope and you gain a Fear.'},{k:A,n:'Deathlock',d:'Spend a Fear to curse a target within Very Close with a necrotic Deathlock until the end of the scene. Attacks made by the Hunter against a Deathlocked target deal direct damage. The Hunter can only maintain one Deathlock at a time.'},{k:A,n:'Inevitable Death',d:'Mark a Stress to spotlight 1d4 allies. Attacks they make while spotlighted in this way deal half damage.'},{k:R,n:'Rampage',d:'Countdown (Loop 1d6). When the Hunter is in the spotlight for the first time, activate the countdown. When it triggers, move the Hunter in a straight line to a point within Far range and make an attack against all targets in their path. Targets hit take 2d8+2 phy.'}]},
  {id:'royal-advisor',tier:2,name:'Royal Advisor',type:'social',dc:14,hp:3,st:3,maj:8,sev:15,atk:'−3',wpn:'Wand · Far',dmg:'1d4+3 phy',motives:'Curry favor, manufacture evidence, scheme',feats:[{k:P,n:'Devastating Retort',d:'A PC who rolls less than 17 on an action roll targeting the Advisor must mark a Stress.'},{k:A,n:'Bend Ears',d:'Mark a Stress to influence an NPC within Melee range with whispered words. That target\'s opinion on one matter shifts toward the Advisor\'s preference unless it is in direct opposition to the target\'s motives.'},{k:A,n:'Scapegoat',d:"Spend a Fear to convince a crowd or notable individual that one person or group is responsible for some problem facing the target. The target becomes hostile to the scapegoat until convinced of their innocence with a successful Presence Roll (17)."}]},
  {id:'secret-keeper',tier:2,name:'Secret-Keeper',type:'leader',dc:16,hp:7,st:4,maj:13,sev:26,atk:'+3',wpn:'Sigil-laden Staff · Far',dmg:'2d12 mag',motives:'Amass great power, plot, take command',feats:[{k:A,n:'Seize Your Moment',d:'Spend 2 Fear to spotlight 1d4 allies. Attacks they make while spotlighted in this way deal half damage.'},{k:R,n:"Our Master's Will",d:'When you spotlight an ally within Far range, mark a Stress to gain a Fear.'},{k:R,n:'Summoning Ritual',d:'Countdown (6). When the Secret-Keeper is in the spotlight for the first time, activate the countdown. When they mark HP, tick down this countdown by the number of HP marked. When it triggers, summon a Minor Demon who appears at Close range.'},{k:R,n:'Fallen Hounds',d:'Once per scene, when the Secret-Keeper marks 2 or more HP, mark a Stress to summon a Demonic Hound Pack, which appears at Close range and is immediately spotlighted.'}]},
  {id:'shark',tier:2,name:'Shark',type:'bruiser',dc:14,hp:7,st:3,maj:14,sev:28,atk:'+2',wpn:'Toothy Maw · Very Close',dmg:'2d12+1 phy',motives:'Find the blood, isolate prey, target the weak',feats:[{k:P,n:'Terrifying',d:'When the Shark makes a successful attack, all PCs within Far range lose a Hope and you gain a Fear.'},{k:P,n:'Rending Bite',d:"When the Shark makes a successful attack, the target must mark an Armor Slot without receiving its benefits. If they can't mark an Armor Slot, they must mark an additional HP."},{k:R,n:'Blood in the Water',d:'When a creature within Close range of the Shark marks HP from another creature\'s attack, mark a Stress to immediately spotlight the Shark, moving them into Melee range of the target and making a standard attack.'}]},
  {id:'siren',tier:2,name:'Siren',type:'skulk',dc:14,hp:5,st:3,maj:9,sev:18,atk:'+2',wpn:'Distended Jaw Bite · Melee',dmg:'2d6+3 phy',motives:'Consume, lure prey, subdue with song',feats:[{k:P,n:'Captive Audience',d:"If the Siren makes a standard attack against a target Entranced by their song, the attack deals 2d10+1 damage instead of standard."},{k:A,n:'Enchanting Song',d:'Spend a Fear to sing a song that affects all targets within Close range. Targets must succeed on an Instinct Reaction Roll or become Entranced until they mark 2 Stress. Other Sirens within Close can mark a Stress to each add a +1 bonus to the Difficulty of the reaction roll. While Entranced, a target can\'t act and is Vulnerable.'}]},
  {id:'spectral-archer',tier:2,name:'Spectral Archer',type:'ranged',dc:13,hp:3,st:3,maj:6,sev:14,atk:'+3',wpn:'Longbow · Far',dmg:'2d10+2 phy',motives:'Move through solid objects, stay out of the fray, rehash old battles',feats:[{k:P,n:'Ghost',d:'The Archer has resistance to physical damage. Mark a Stress to move up to Close range through solid objects.'},{k:A,n:'Pick Your Target',d:'Spend a Fear to make an attack within Far range against a PC who is within Very Close range of at least two other PCs. On a success, the target takes 2d8+12 phy.'}]},
  {id:'spectral-captain',tier:2,name:'Spectral Captain',type:'leader',dc:16,hp:6,st:4,maj:13,sev:26,atk:'+3',wpn:'Longbow · Far',dmg:'2d10+3 phy',motives:'Move through solid objects, rally troops, rehash old battles',feats:[{k:P,n:'Ghost',d:'The Captain has resistance to physical damage. Mark a Stress to move up to Close range through solid objects.'},{k:A,n:'Unending Battle',d:'Spend 2 Fear to return up to 1d4+1 defeated Spectral allies to the battle at the points where they first appeared (with no marked HP or Stress).'},{k:R,n:'Hold Fast',d:"When the Captain's Spectral allies are forced to make a reaction roll, mark a Stress to give those allies a +2 bonus to the roll."},{k:R,n:'Momentum',d:'When the Captain makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'spectral-guardian',tier:2,name:'Spectral Guardian',type:'standard',dc:15,hp:4,st:3,maj:7,sev:15,atk:'+1',wpn:'Spear · Very Close',dmg:'2d8+1 phy',motives:'Move through solid objects, protect treasure, rehash old battles',feats:[{k:P,n:'Ghost',d:'The Guardian has resistance to physical damage. Mark a Stress to move up to Close range through solid objects.'},{k:A,n:'Grave Blade',d:'Spend a Fear to make an attack against a target within Very Close range. On a success, deal 2d10+6 phy and the target must mark a Stress.'}]},
  {id:'spy',tier:2,name:'Spy',type:'social',dc:15,hp:4,st:3,maj:8,sev:17,atk:'−2',wpn:'Dagger · Melee',dmg:'2d6+3 phy',motives:'Cut and run, disguise appearance, eavesdrop',feats:[{k:A,n:'Gathering Secrets',d:'Spend a Fear to describe how the Spy knows a secret about a PC in the scene.'},{k:R,n:'Fly on the Wall',d:'When a PC or group is discussing something sensitive, mark a Stress to reveal that the Spy is present in the scene, observing them. If the Spy escapes the scene to report their findings, gain 1d4 Fear.'}]},
  {id:'stonewraith',tier:2,name:'Stonewraith',type:'skulk',dc:13,hp:6,st:3,maj:11,sev:22,atk:'+3',wpn:'Bite and Claws · Melee',dmg:'2d8+6 phy',motives:'Defend territory, isolate prey, stalk',feats:[{k:P,n:'Stonestrider',d:'The Stonewraith can move through stone and earth as easily as air. While within stone or earth, they are Hidden and immune to all damage.'},{k:A,n:'Rocky Ambush',d:'While Hidden, mark a Stress to leap into Melee range with a target within Very Close. The target must succeed on an Agility or Instinct Reaction Roll (15) or take 2d8 phy and become temporarily Restrained.'},{k:A,n:'Avalanche Roar',d:'Spend a Fear to roar while within a cave and cause a cave-in. All targets within Close must succeed on an Agility Reaction Roll (14) or take 2d10 phy. The rubble can be cleared with a Progress Countdown (8).'},{k:R,n:'Momentum',d:'When the Stonewraith makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'war-wizard',tier:2,name:'War Wizard',type:'ranged',dc:16,hp:5,st:6,maj:11,sev:23,atk:'+4',wpn:'Staff · Far',dmg:'2d10+4 mag',motives:'Develop new spells, seek power, shatter formations',feats:[{k:P,n:'Battle Teleport',d:'Before or after making a standard attack, mark a Stress to teleport to a location within Far range.'},{k:A,n:'Refresh Warding Sphere',d:"Mark a Stress to refresh the Wizard's Warding Sphere reaction."},{k:A,n:'Eruption',d:'Spend a Fear and choose a point within Far range. A Very Close area around that point erupts into impassable terrain. All targets within that area must make an Agility Reaction Roll (14). Targets who fail take 2d10 phy and are thrown out of the area. Targets who succeed take half damage and aren\'t moved.'},{k:A,n:'Arcane Artillery',d:'Spend a Fear to unleash a precise hail of magical blasts. All targets in the scene must make an Agility Reaction Roll. Targets who fail take 2d12 mag. Targets who succeed take half damage.'},{k:R,n:'Warding Sphere',d:'When the Wizard takes damage from an attack within Close range, deal 2d6 mag to the attacker. This reaction can\'t be used again until the Wizard refreshes it with Refresh Warding Sphere.'}]},
  // ── Tier 3 ──────────────────────────────────────────────────────────────
  {id:'adult-flickerfly',tier:3,name:'Adult Flickerfly',type:'solo',dc:17,hp:12,st:6,maj:20,sev:35,atk:'+3',wpn:'Wing Slash · Very Close',dmg:'3d20 phy',motives:'Collect shiny things, hunt, nest, swoop',feats:[{k:P,n:'Relentless (4)',d:'The Flickerfly can be spotlighted up to four times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Never Misses',d:"When the Flickerfly makes an attack, the target's Evasion is halved against the attack."},{k:P,n:'Deadly Flight',d:'While flying, the Flickerfly can move up to Far range instead of Close range before taking an action.'},{k:A,n:'Whirlwind',d:'Spend a Fear to whirl, making an attack against all targets within Very Close range. Targets the Flickerfly succeeds against take 3d8 direct physical damage.'},{k:A,n:'Mind Dance',d:"Mark a Stress to create a magically dazzling display. All targets within Close range must make an Instinct Reaction Roll. For each target who failed, you gain a Fear and the Flickerfly learns one of the target's fears."},{k:R,n:'Hallucinatory Breath',d:"Countdown (Loop 1d6). When the Flickerfly takes damage for the first time, activate the countdown. When it triggers, the Flickerfly breathes hallucinatory gas on all targets in front of them up to Far range. Targets must make an Instinct Reaction Roll or be tormented by fearful hallucinations. Targets whose fears are known to the Flickerfly have disadvantage on this roll. Targets who fail lose 2 Hope and take 3d8+3 direct magic damage."},{k:R,n:'Uncanny Reflexes',d:'When the Flickerfly takes damage from an attack within Close range, you can mark a Stress to take half damage.'}]},
  {id:'demon-of-avarice',tier:3,name:'Demon of Avarice',type:'support',dc:17,hp:6,st:5,maj:15,sev:29,atk:'+2',wpn:'Hungry Maw · Melee',dmg:'3d6+5 mag',motives:'Consume, fuel greed, sow dissent',feats:[{k:P,n:'Money Talks',d:"Attacks against the Demon are made with disadvantage unless the attacker spends a handful of gold. This Demon starts with a number of handfuls equal to the number of PCs. When a target marks HP from the Demon's standard attack, they can spend a handful of gold instead of marking HP (1 handful per HP)."},{k:P,n:'Numbers Must Go Up',d:"Add a bonus to the Demon's attack rolls equal to the number of handfuls of gold they have."},{k:A,n:'Money Is Time',d:'Spend 3 handfuls of gold (or a Fear) to spotlight 1d4+1 allies.'}]},
  {id:'demon-of-despair',tier:3,name:'Demon of Despair',type:'skulk',dc:17,hp:6,st:5,maj:18,sev:35,atk:'+3',wpn:'Miasma Bolt · Far',dmg:'3d6+1 mag',motives:'Make fear contagious, stick to the shadows, undermine resolve',feats:[{k:P,n:'Depths of Despair',d:'The Demon deals double damage to PCs with 0 Hope.'},{k:A,n:'Your Struggle Is Pointless',d:'Spend a Fear to weigh down the spirits of all PCs within Far range. All targets affected replace their Hope Die with a d8 until they roll a success with Hope or their next rest.'},{k:R,n:'Your Friends Will Fail You',d:'When a PC fails with Fear, you can mark a Stress to cause all other PCs within Close range to lose a Hope.'},{k:R,n:'Momentum',d:'When the Demon makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'demon-of-hubris',tier:3,name:'Demon of Hubris',type:'leader',dc:18,hp:7,st:5,maj:18,sev:36,atk:'+4',wpn:'Perfect Spear · Very Close',dmg:'3d10 phy',motives:'Condescend, declare premature victory, prove superiority',feats:[{k:P,n:'Terrifying',d:'When the Demon makes a successful attack, all PCs within Far range must lose a Hope and you gain a Fear.'},{k:P,n:'Double or Nothing',d:'When a PC within Far range fails a roll, they can choose to reroll their Fear Die and take the new result. If they still fail, they mark 2 Stress and the Demon clears a Stress.'},{k:A,n:'Unparalleled Skill',d:"Mark a Stress to deal the Demon's standard attack damage to a target within Close range."},{k:A,n:'The Root of Villainy',d:'Spend a Fear to spotlight two other Demons within Far range.'},{k:R,n:'You Pale in Comparison',d:'When a PC fails a roll within Close range of the Demon, they must mark a Stress.'}]},
  {id:'demon-of-jealousy',tier:3,name:'Demon of Jealousy',type:'ranged',dc:17,hp:6,st:6,maj:17,sev:30,atk:'+4',wpn:'Psychic Assault · Far',dmg:'3d8+3 mag',motives:"Join in on others' success, take what belongs to others, hold grudges",feats:[{k:P,n:'Unprotected Mind',d:"The Demon's standard attack deals direct damage."},{k:R,n:'My Turn',d:'When the Demon marks HP from an attack, spend a number of Fear equal to the HP marked to cause the attacker to mark the same number of HP.'},{k:R,n:'Rivalry',d:'When a creature within Close range takes damage from a different adversary, you can mark a Stress to add a d4 to the damage roll.'},{k:R,n:"What's Yours Is Mine",d:"When a PC takes Severe damage within Very Close range of the Demon, you can spend a Fear to cause the target to make a Finesse Reaction Roll. On a failure, the Demon seizes one item or consumable from the target's inventory."}]},
  {id:'demon-of-wrath',tier:3,name:'Demon of Wrath',type:'bruiser',dc:17,hp:7,st:5,maj:22,sev:40,atk:'+3',wpn:'Fists · Very Close',dmg:'3d8+1 mag',motives:'Fuel anger, impress rivals, wreak havoc',feats:[{k:P,n:'Anger Unrelenting',d:"The Demon's attacks deal direct damage."},{k:A,n:'Battle Lust',d:'Spend a Fear to boil the blood of all PCs within Far range. They use a d20 as their Fear Die until the end of the scene.'},{k:R,n:'Retaliation',d:'When the Demon takes damage from an attack within Close range, you can mark a Stress to make a standard attack against the attacker.'},{k:R,n:'Blood and Souls',d:'Countdown (Loop 6). Activate the first time an attack is made within sight of the Demon. It ticks down when a PC takes a violent action. When it triggers, summon 1d4 Minor Demons, who appear at Close range.'}]},
  {id:'dire-bat',tier:3,name:'Dire Bat',type:'skulk',dc:14,hp:5,st:3,maj:16,sev:30,atk:'+2',wpn:'Claws and Teeth · Melee',dmg:'2d6+7 phy',motives:'Dive-bomb, hide, protect leader',feats:[{k:P,n:'Flying',d:'While flying, the Bat gains a +3 bonus to their Difficulty.'},{k:A,n:'Screech',d:'Mark a Stress to send a high-pitch screech toward all targets in front of the Bat within Far range. Those targets must mark 1d4 Stress.'},{k:R,n:'Guardian',d:'When an allied Vampire marks HP, you can mark a Stress to fly into Melee range of the attacker and make an attack with advantage against them. On a success, deal 2d6+2 physical damage.'}]},
  {id:'dryad',tier:3,name:'Dryad',type:'leader',dc:16,hp:8,st:5,maj:24,sev:38,atk:'+4',wpn:'Deadfall Shortbow · Far',dmg:'3d10+1 phy',motives:'Command, cultivate, drive out, preserve the forest',feats:[{k:A,n:'Bramble Patch',d:'Mark a Stress to target a point within Far range. Create a patch of thorns within Close range of that point. All targets within take 2d6+2 physical damage when they act. A target must succeed on a Finesse Roll or deal more than 20 damage to the Dryad to leave the area.'},{k:A,n:'Grow Saplings',d:'Spend a Fear to grow three Treant Sapling Minions, who appear at Close range and immediately take the spotlight.'},{k:R,n:'We Are All One',d:"When an ally dies within Close range, you can spend a Fear to clear 2 HP and 2 Stress as the fallen ally's life force is returned to the forest."}]},
  {id:'elemental-spark',tier:3,name:'Elemental Spark',type:'minion',dc:15,hp:1,st:1,maj:null,sev:null,atk:'+0',wpn:'Bursts of Fire · Close',dmg:'5 mag',motives:'Blast, consume, gain mass',feats:[{k:P,n:'Minion (9)',d:'The Elemental is defeated when they take any damage. For every 9 damage a PC deals to the Elemental, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Elemental Sparks within Close range of them. Those Minions move into Melee range and make one shared attack roll. On a success, they deal 5 magic damage each. Combine this damage.'}]},
  {id:'greater-earth-elemental',tier:3,name:'Greater Earth Elemental',type:'bruiser',dc:17,hp:10,st:4,maj:22,sev:40,atk:'+7',wpn:'Boulder Fist · Very Close',dmg:'3d10+1 phy',motives:'Avalanche, knock over, pummel',feats:[{k:P,n:'Slow',d:"When you spotlight the Elemental and they don't have a token, they can't act yet. Place a token on their stat block. When you spotlight them again with a token, clear it and they can act."},{k:P,n:'Crushing Blows',d:"When the Elemental makes a successful attack, the target must mark an Armor Slot without receiving its benefits (they can still use armor to reduce the damage). If they can't mark an Armor Slot, they must mark an additional HP."},{k:P,n:'Immovable Object',d:'An attack that would move the Elemental moves them two fewer ranges (e.g. Far becomes Very Close). When the Elemental takes physical damage, reduce it by 7.'},{k:A,n:'Rockslide',d:'Mark a Stress to create a rockslide within Close range. All targets must make an Agility Reaction Roll (19). Targets who fail take 2d12+5 physical damage and become Vulnerable until their next roll with Hope. Targets who succeed take half damage.'},{k:R,n:'Momentum',d:'When the Elemental makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'greater-water-elemental',tier:3,name:'Greater Water Elemental',type:'support',dc:17,hp:5,st:5,maj:17,sev:34,atk:'+3',wpn:'Crashing Wave · Very Close',dmg:'3d4+1 mag',motives:'Deluge, disperse, drown',feats:[{k:A,n:'Water Jet',d:"Mark a Stress to attack a target within Very Close range. On a success, deal 2d4+7 physical damage and the target's next action has disadvantage. On a failure, the target must mark a Stress."},{k:A,n:'Drowning Embrace',d:'Spend a Fear to make an attack against all targets within Very Close range. Targets the Elemental succeeds against become Restrained and Vulnerable as they begin drowning. A target can break free with a successful Strength or Instinct Roll.'},{k:R,n:'High Tide',d:'When the Elemental makes a successful standard attack, you can mark a Stress to knock the target back to Close range.'}]},
  {id:'huge-green-ooze',tier:3,name:'Huge Green Ooze',type:'skulk',dc:15,hp:7,st:4,maj:15,sev:30,atk:'+3',wpn:'Ooze Appendage · Melee',dmg:'3d8+1 mag',motives:'Camouflage, creep up, envelop, multiply',feats:[{k:P,n:'Slow',d:"When you spotlight the Ooze and they don't have a token, they can't act yet. Place a token on their stat block. When you spotlight them again with a token, clear it and they can act."},{k:P,n:'Acidic Form',d:"When the Ooze makes a successful attack, the target must mark an Armor Slot without receiving its benefits. If they can't mark an Armor Slot, they must mark an additional HP."},{k:A,n:'Envelop',d:'Make an attack against a target within Melee range. On a success, the Ooze Envelops them and the target must mark 2 Stress. While Enveloped, the target must mark an additional Stress every time they make an action roll. When the Ooze takes Severe damage, all Enveloped targets are freed.'},{k:R,n:'Split',d:'When the Ooze has 4 or more HP marked, you can spend a Fear to split them into two Green Oozes (with no marked HP or Stress). Immediately spotlight both of them.'}]},
  {id:'hydra',tier:3,name:'Hydra',type:'solo',dc:18,hp:10,st:5,maj:19,sev:35,atk:'+3',wpn:'Bite · Close',dmg:'2d12+2 phy',motives:'Devour, regenerate, terrify',feats:[{k:P,n:'Many-Headed Menace',d:'The Hydra begins with three heads and can have up to five. When the Hydra takes Major or greater damage, they lose a head.'},{k:P,n:'Relentless (X)',d:"The Hydra can be spotlighted X times per GM turn, where X is the Hydra's number of heads. Spend Fear as usual to spotlight them."},{k:A,n:'Regeneration',d:'If the Hydra has any marked HP, spend a Fear to clear a HP and grow two heads.'},{k:A,n:'Terrifying Chorus',d:'All PCs within Far range lose 2 Hope.'},{k:R,n:'Magical Weakness',d:"When the Hydra takes magic damage, they become Dazed until the next roll with Fear. While Dazed, they can't use their Regeneration action but are immune to magic damage."}]},
  {id:'monarch',tier:3,name:'Monarch',type:'social',dc:16,hp:6,st:5,maj:16,sev:32,atk:'+0',wpn:'Warhammer · Melee',dmg:'3d6+3 phy',motives:'Control vassals, destroy rivals, forge a legacy',feats:[{k:A,n:'Execute Them!',d:"Spend a Fear per PC in the party to have the group condemned for crimes real or imagined. A PC who succeeds on a Presence Roll can demand trial by combat or another special form of trial."},{k:A,n:'Crownsguard',d:"Once per scene, mark a Stress to summon six Tier 3 Minions, who appear at Close range to enforce the Monarch's will."},{k:R,n:'Casus Belli',d:"Long-Term Countdown (8). Spend a Fear to activate after the Monarch's desire for war is first revealed. When it triggers, the Monarch has a reason to rally the nation to war. You gain 1d4 Fear."}]},
  {id:'stag-knight',tier:3,name:'Stag Knight',type:'standard',dc:17,hp:7,st:5,maj:19,sev:36,atk:'+3',wpn:'Bramble Sword · Melee',dmg:'3d8+3 phy',motives:'Isolate, maneuver, protect the forest, weed the unwelcome',feats:[{k:P,n:'From Above',d:'When the Knight succeeds on a standard attack from above a target, they deal 3d12+3 physical damage instead of their standard damage.'},{k:A,n:'Blade of the Forest',d:"Spend a Fear to make an attack against all targets within Very Close range. Targets the Knight succeeds against take physical damage equal to 3d4 + the target's Major threshold."},{k:R,n:'Thorny Armor',d:'When the Knight takes damage from an attack within Melee range, you can mark a Stress to deal 1d10+5 physical damage to the attacker.'}]},
  {id:'oak-treant',tier:3,name:'Oak Treant',type:'bruiser',dc:17,hp:7,st:4,maj:22,sev:40,atk:'+2',wpn:'Branch · Very Close',dmg:'3d8+2 phy',motives:'Hide in plain sight, preserve the forest, root down, swing branches',feats:[{k:P,n:'Just a Tree',d:'Before they make their first attack in a fight or after they become Hidden, the Treant is indistinguishable from other trees until they next act or a PC succeeds on an Instinct Roll to identify them.'},{k:A,n:'Seed Barrage',d:'Mark a Stress and make an attack against up to three targets within Close range, pummeling them with giant acorns. Targets the Treant succeeds against take 2d10+5 physical damage.'},{k:A,n:'Take Root',d:'Mark a Stress to Root the Treant in place. The Treant is Restrained while Rooted, and can end this effect instead of moving while spotlighted. While Rooted, the Treant has resistance to physical damage.'}]},
  {id:'treant-sapling',tier:3,name:'Treant Sapling',type:'minion',dc:14,hp:1,st:1,maj:null,sev:null,atk:'+0',wpn:'Branches · Melee',dmg:'8 phy',motives:'Blend in, preserve the forest, pummel, surround',feats:[{k:P,n:'Minion (6)',d:'The Sapling is defeated when they take any damage. For every 6 damage a PC deals to the Sapling, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Treant Saplings within Close range of them. Those Minions move into Melee range and make one shared attack roll. On a success, they deal 8 physical damage each. Combine this damage.'}]},
  {id:'head-vampire',tier:3,name:'Head Vampire',type:'leader',dc:17,hp:6,st:6,maj:22,sev:42,atk:'+5',wpn:'Rapier · Melee',dmg:'2d20+4 phy',motives:'Create thralls, charm, command, fly, intimidate',feats:[{k:P,n:'Terrifying',d:'When the Vampire makes a successful attack, all PCs within Far range lose a Hope and you gain a Fear.'},{k:P,n:'Look into My Eyes',d:'A creature who moves into Melee range of the Vampire must make an Instinct Reaction Roll. On a failure, you gain 1d4 Fear.'},{k:A,n:'Feed on Followers',d:"When the Vampire is within Melee range of an ally, they can cause the ally to mark a HP. The Vampire then clears a HP."},{k:A,n:'The Hunt Is On',d:'Spend 2 Fear to summon 1d4 Vampires, who appear at Far range and immediately take the spotlight.'},{k:R,n:'Lifesuck',d:'When the Vampire is spotlighted, roll a d8. On a result of 6 or higher, all targets within Very Close range must mark a HP.'}]},
  {id:'vampire',tier:3,name:'Vampire',type:'standard',dc:16,hp:5,st:4,maj:18,sev:35,atk:'+3',wpn:'Rapier · Melee',dmg:'3d8 phy',motives:'Bite, charm, deceive, feed, intimidate',feats:[{k:A,n:'Draining Bite',d:'Make an attack against a target within Melee range. On a success, deal 5d4 physical damage. A target who marks HP from this attack loses a Hope and must mark a Stress. The Vampire then clears a HP.'},{k:R,n:'Mistform',d:'When the Vampire takes physical damage, you can spend a Fear to take half damage.'}]},
  {id:'vault-guardian-gaoler',tier:3,name:'Vault Guardian Gaoler',type:'support',dc:16,hp:5,st:3,maj:19,sev:33,atk:'+2',wpn:'Body Bash · Very Close',dmg:'3d6+2 phy',motives:'Carry away, entrap, protect, pummel',feats:[{k:P,n:'Blocking Shield',d:'Creatures within Melee range of the Gaoler have disadvantage on attack rolls against them. Creatures trapped inside the Gaoler are immune to this feature.'},{k:A,n:'Lock Up',d:'Mark a Stress to make an attack against a target within Very Close range. On a success, the target is Restrained within the Gaoler until freed with a successful Strength Roll (18). While Restrained, the target can only attack the Gaoler.'}]},
  {id:'vault-guardian-sentinel',tier:3,name:'Vault Guardian Sentinel',type:'bruiser',dc:17,hp:6,st:3,maj:21,sev:40,atk:'+3',wpn:'Charged Mace · Very Close',dmg:'2d12+1 phy',motives:'Destroy at any cost, expunge, protect',feats:[{k:P,n:'Kinetic Slam',d:"Targets who take damage from the Sentinel's standard attack are knocked back to Very Close range."},{k:A,n:'Box In',d:'Mark a Stress to choose a target within Very Close range to focus on. That target has disadvantage on attack rolls when within Very Close range of the Sentinel. The Sentinel can only focus on one target at a time.'},{k:A,n:'Mana Bolt',d:'Spend a Fear to lob explosive magic at a point within Far range. All targets within Very Close range of that point must make an Agility Reaction Roll. Targets who fail take 2d8+20 magic damage and are knocked back to Close range. Targets who succeed take half damage.'},{k:R,n:'Momentum',d:'When the Sentinel makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'vault-guardian-turret',tier:3,name:'Vault Guardian Turret',type:'ranged',dc:16,hp:5,st:4,maj:20,sev:32,atk:'+3',wpn:'Magitech Cannon · Far',dmg:'3d10+3 mag',motives:'Concentrate fire, lock down, mark, protect',feats:[{k:P,n:'Slow Firing',d:"When you spotlight the Turret and they don't have a token, they can't make a standard attack. Place a token on their stat block. When you spotlight them again with a token, clear it and they can attack."},{k:A,n:'Mark Target',d:'Spend a Fear to Mark a target within Far range until the Turret is destroyed or the Marked target becomes Hidden. While the target is Marked, their Evasion is halved.'},{k:R,n:'Concentrate Fire',d:"When another adversary deals damage to a target within Far range of the Turret, you can mark a Stress to add the Turret's standard attack damage to the damage roll."},{k:R,n:'Detonation',d:'When the Turret is destroyed, they explode. All targets within Close range must make an Agility Reaction Roll. Targets who fail take 3d20 physical damage. Targets who succeed take half damage.'}]},
  {id:'young-ice-dragon',tier:3,name:'Young Ice Dragon',type:'solo',dc:18,hp:10,st:6,maj:21,sev:41,atk:'+7',wpn:'Bite and Claws · Close',dmg:'4d10 phy',motives:'Avalanche, defend lair, fly, freeze, maul',feats:[{k:P,n:'Relentless (3)',d:'The Dragon can be spotlighted up to three times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Rend and Crush',d:"If a target damaged by the Dragon doesn't mark an Armor Slot to reduce the damage, they must mark a Stress."},{k:P,n:'No Hope',d:'When a PC rolls with Fear while within Far range of the Dragon, they lose a Hope.'},{k:A,n:'Blizzard Breath',d:'Spend 2 Fear to release an icy whorl in front of the Dragon within Close range. All targets must make an Agility Reaction Roll. Targets who fail take 4d6+5 magic damage and are Restrained by ice until they break free with a successful Strength Roll. Targets who succeed must mark 2 Stress or take half damage.'},{k:A,n:'Avalanche',d:'Spend a Fear to have the Dragon unleash a huge downfall of snow and ice within Far range. All targets must succeed on an Instinct Reaction Roll or become Vulnerable until they dig themselves out. For each PC that fails, you gain a Fear.'},{k:R,n:'Frozen Scales',d:'When a creature makes a successful attack against the Dragon from within Very Close range, they must mark a Stress and become Chilled until their next rest or they clear a Stress. While Chilled, they have disadvantage on attack rolls.'},{k:R,n:'Momentum',d:'When the Dragon makes a successful attack against a PC, you gain a Fear.'}]},
  // ── Tier 4 ──────────────────────────────────────────────────────────────
  {id:'arch-necromancer',tier:4,name:'Arch-Necromancer',type:'leader',dc:21,hp:9,st:8,maj:33,sev:66,atk:'+6',wpn:'Necrotic Blast · Far',dmg:'4d12+8 mag',motives:'Corrupt, decay, flee to fight another day, resurrect',feats:[{k:A,n:'Dance of Death',d:'Mark a Stress to spotlight 1d4 allies. Attacks they make while spotlighted in this way deal half damage, or full damage if you spend a Fear.'},{k:A,n:'Beam of Decay',d:'Mark 2 Stress to cause all targets within Far range to make a Strength Reaction Roll. Targets who fail take 2d20+12 magic damage and you gain a Fear. Targets who succeed take half damage. A target who marks 2 or more HP must also mark 2 Stress and becomes Vulnerable until they roll with Hope.'},{k:A,n:'Open the Gates of Death',d:'Spend a Fear to summon a Zombie Legion, which appears at Close range and immediately takes the spotlight.'},{k:R,n:'Not Today, My Dears',d:'When the Necromancer has marked 7 or more of their HP, you can spend a Fear to have them teleport away to a safe location to recover. A PC who succeeds on an Instinct Roll can trace the teleportation magic to their destination.'},{k:R,n:'Your Life Is Mine',d:'Countdown (Loop 2d6). When the Necromancer has marked 6 or more of their HP, activate the countdown. When it triggers, deal 2d10+6 direct magic damage to a target within Close range. The Necromancer then clears a number of Stress or HP equal to the HP marked by the target.'}]},
  {id:'fallen-shock-troop',tier:4,name:'Fallen Shock Troop',type:'minion',dc:18,hp:1,st:1,maj:null,sev:null,atk:'+2',wpn:'Cursed Axe · Very Close',dmg:'12 phy',motives:'Crush, dominate, earn relief, punish',feats:[{k:P,n:'Minion (12)',d:'The Shock Troop is defeated when they take any damage. For every 12 damage a PC deals to the Shock Troop, defeat an additional Minion within range the attack would succeed against.'},{k:P,n:'Aura of Doom',d:'When a PC marks HP from an attack by the Shock Troop, they lose a Hope.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Fallen Shock Troops within Close range of them. Those Minions move into Melee range and make one shared attack roll. On a success, they deal 12 physical damage each. Combine this damage.'}]},
  {id:'fallen-sorcerer',tier:4,name:'Fallen Sorcerer',type:'support',dc:19,hp:6,st:5,maj:26,sev:42,atk:'+4',wpn:'Corrupted Staff · Far',dmg:'4d6+10 mag',motives:'Acquire, dishearten, dominate, torment',feats:[{k:A,n:'Conflagration',d:'Spend a Fear to unleash an all-consuming firestorm and make an attack against all targets within Close range. Targets the Sorcerer succeeds against take 2d10+6 direct magic damage.'},{k:A,n:'Nightmare Tableau',d:'Mark a Stress to trap a target within Far range in a powerful illusion of their worst fears. While trapped, the target is Restrained and Vulnerable until they break free with a successful Instinct Roll.'},{k:R,n:'Slippery',d:'When the Sorcerer takes damage from an attack, they can teleport up to Far range.'},{k:R,n:'Shackles of Guilt',d:'Countdown (Loop 2d6). When the Sorcerer is in the spotlight for the first time, activate the countdown. When it triggers, all targets within Far range become Vulnerable and must mark a Stress as they relive their greatest regrets. A target can break free with a successful Presence or Strength Roll. When a PC fails to break free, they lose a Hope.'}]},
  {id:'fallen-warlord-realm-breaker',tier:4,name:'Fallen Warlord: Realm-Breaker',type:'solo',dc:20,hp:8,st:5,maj:36,sev:66,atk:'+7',wpn:'Barbed Whip · Close',dmg:'4d8+7 phy',motives:'Corrupt, dominate, punish, break the weak',feats:[{k:P,n:'Relentless (2)',d:'The Realm-Breaker can be spotlighted up to two times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Firespite Plate Armor',d:'When the Realm-Breaker takes damage, reduce it by 2d10.'},{k:A,n:'Tormenting Lash',d:'Mark a Stress to make a standard attack against all targets within Very Close range. When a target uses armor to reduce damage from this attack, they must mark 2 Armor Slots.'},{k:R,n:'All-Consuming Rage',d:'Countdown (Decreasing 8). When the Realm-Breaker is first spotlighted, activate the countdown. When it triggers, all targets within Far range must make a Presence Reaction Roll. Targets who fail take 2d6+10 direct magic damage; targets who succeed take half. For each HP marked, summon a Fallen Shock Troop within Very Close range of the target who marked it.'},{k:R,n:'Doombringer',d:'When a target marks HP from an attack by the Realm-Breaker, all PCs within Far range of the target must lose a Hope.'},{k:R,n:'I Have Never Known Defeat',d:'Phase Change: When the Realm-Breaker marks their last HP, replace them with the Undefeated Champion and immediately spotlight them.'}]},
  {id:'fallen-warlord-undefeated-champion',tier:4,name:'Fallen Warlord: Undefeated Champion',type:'solo',dc:18,hp:11,st:5,maj:35,sev:58,atk:'+8',wpn:'Heart-Shattering Sword · Very Close',dmg:'4d12+13 phy',motives:'Dispatch merciless death, punish the defiant, secure victory at any cost',feats:[{k:P,n:'Relentless (3)',d:'The Undefeated Champion can be spotlighted up to three times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Faltering Armor',d:'When the Undefeated Champion takes damage, reduce it by 1d10.'},{k:A,n:'Shattering Strike',d:'Mark a Stress to make a standard attack against all targets within Very Close range. PCs the Champion succeeds against lose a number of Hope equal to the HP they marked from this attack.'},{k:A,n:'Endless Legions',d:'Spend a Fear to summon a number of Fallen Shock Troops equal to twice the number of PCs. The Shock Troops appear at Far range.'},{k:R,n:'Circle of Defilement',d:'Countdown (1d8). When the Undefeated Champion is first spotlighted, activate the countdown. When it triggers, activate a magical circle within Far range of the Champion. A target within that area is Vulnerable until they leave the circle. The circle can be removed by dealing Severe damage to the Champion.'},{k:R,n:'Momentum',d:'When the Undefeated Champion makes a successful attack against a PC, you gain a Fear.'},{k:R,n:'Doombringer',d:'When a target marks HP from an attack by the Undefeated Champion, all PCs within Far range of the target lose a Hope.'}]},
  {id:'hallowed-archer',tier:4,name:'Hallowed Archer',type:'ranged',dc:19,hp:3,st:2,maj:25,sev:45,atk:'+4',wpn:'Sanctified Longbow · Far',dmg:'4d8+8 phy',motives:'Focus fire, obey, reposition, volley',feats:[{k:P,n:'Punish the Guilty',d:'The Archer deals double damage to targets marked Guilty by a High Seraph.'},{k:A,n:'Divine Volley',d:'Mark a Stress to make a standard attack against up to three targets.'}]},
  {id:'hallowed-soldier',tier:4,name:'Hallowed Soldier',type:'minion',dc:18,hp:1,st:2,maj:null,sev:null,atk:'+2',wpn:'Sword and Shield · Melee',dmg:'10 phy',motives:'Obey, outmaneuver, punish, swarm',feats:[{k:P,n:'Minion (13)',d:'The Soldier is defeated when they take any damage. For every 13 damage a PC deals to the Soldier, defeat an additional Minion within range the attack would succeed against.'},{k:P,n:'Divine Flight',d:'While the Soldier is flying, spend a Fear to move up to Far range instead of Close range before taking an action.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Hallowed Soldiers within Close range of them. Those Minions move into Melee range and make one shared attack roll. On a success, they deal 10 physical damage each. Combine this damage.'}]},
  {id:'high-seraph',tier:4,name:'High Seraph',type:'leader',dc:20,hp:7,st:5,maj:37,sev:70,atk:'+8',wpn:'Holy Sword · Very Close',dmg:'4d10+10 phy',motives:'Enforce dogma, fly, pronounce judgment, smite',feats:[{k:P,n:'Relentless (3)',d:'The Seraph can be spotlighted up to three times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Divine Flight',d:'While the Seraph is flying, spend a Fear to move up to Far range instead of Close range before taking an action.'},{k:A,n:'Judgment',d:"Spend a Fear to make a target Guilty in the eyes of the Seraph's god until the Seraph is defeated. While Guilty, the target doesn't gain Hope on a result with Hope. When the Seraph succeeds on a standard attack against a Guilty target, they deal Severe damage instead. The Seraph can only mark one target at a time."},{k:A,n:'God Rays',d:'Mark a Stress to reflect a sliver of divinity as a searing beam of light hitting up to twenty targets within Very Far range. Targets must make a Presence Reaction Roll, with disadvantage if marked Guilty. Targets who fail take 4d6+12 magic damage. Targets who succeed take half damage.'},{k:A,n:'We Are One',d:'Once per scene, spend a Fear to spotlight all other adversaries within Far range. Attacks they make while spotlighted in this way deal half damage.'}]},
  {id:'kraken',tier:4,name:'Kraken',type:'solo',dc:20,hp:11,st:8,maj:35,sev:70,atk:'+7',wpn:'Tentacles · Close',dmg:'4d12+10 phy',motives:'Consume, crush, drown, grapple',feats:[{k:P,n:'Relentless (3)',d:'The Kraken can be spotlighted up to three times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Many Tentacles',d:'While the Kraken has 7 or fewer marked HP, they can make their standard attack against two targets within range.'},{k:A,n:'Grapple and Drown',d:'Make an attack roll against a target within Close range. On a success, mark a Stress to grab them and drag them beneath the water. The target is Restrained and Vulnerable until they break free with a successful Strength Roll or the Kraken takes Major or greater damage. While Restrained and Vulnerable, a target must mark a Stress when they make an action roll.'},{k:A,n:'Boiling Blast',d:'Spend a Fear to spew a line of boiling water at any number of targets in a line up to Far range. All targets must succeed on an Agility Reaction Roll or take 4d6+9 physical damage. If a target marks an Armor Slot to reduce the damage, they must also mark a Stress.'},{k:R,n:'Momentum',d:'When the Kraken makes a successful attack against a PC, you gain a Fear.'}]},
  {id:'oracle-of-doom',tier:4,name:'Oracle of Doom',type:'solo',dc:20,hp:11,st:10,maj:38,sev:68,atk:'+8',wpn:'Psychic Attack · Far',dmg:'4d8+9 mag',motives:'Change environment, condemn, dishearten, toss aside',feats:[{k:P,n:'Terrifying',d:'When the Oracle makes a successful attack, all PCs within Far range lose a Hope and you gain a Fear.'},{k:P,n:'Walls Closing In',d:'When a creature rolls a failure while within Very Far range of the Oracle, they must mark a Stress.'},{k:A,n:'Pronounce Fate',d:'Spend a Fear to present a target within Far range with a vision of their personal nightmare. The target must make a Knowledge Reaction Roll. On a failure, they lose all Hope and take 2d20+4 direct magic damage. On a success, they take half damage and lose a Hope.'},{k:A,n:'Summon Tormentors',d:"Once per day, spend 2 Fear to summon 2d4 Tier 2 or below Minions relevant to one of the PC's personal nightmares. They appear at Close range relative to that PC."},{k:R,n:'Ominous Knowledge',d:'When the Oracle sees a mortal creature, they instantly know one of their personal nightmares.'},{k:R,n:'Vengeful Fate',d:'When the Oracle marks HP from an attack within Very Close range, you can mark a Stress to knock the attacker back to Far range and deal 2d10+4 physical damage.'}]},
  {id:'outer-realms-abomination',tier:4,name:'Outer Realms Abomination',type:'bruiser',dc:19,hp:7,st:5,maj:35,sev:71,atk:'+2d4',wpn:'Massive Pseudopod · Very Close',dmg:'4d6+13 mag',motives:'Demolish, devour, undermine',feats:[{k:P,n:'Chaotic Form',d:'When the Abomination attacks, roll 2d4 and use the result as their attack modifier.'},{k:P,n:'Disorienting Presence',d:'When a target takes damage from the Abomination, they must make an Instinct Reaction Roll. On a failure, they gain disadvantage on their next action roll and you gain a Fear.'},{k:A,n:'Reality Quake',d:'Spend a Fear to rattle the edges of reality within Far range. All targets must succeed on a Knowledge Reaction Roll or become Unstuck from reality until the end of the scene. When an Unstuck target spends Hope or marks Armor Slots, HP, or Stress, they must double the amount spent or marked.'},{k:R,n:'Unreal Form',d:'When the Abomination takes damage, reduce it by 1d20. If the Abomination marks 1 or fewer HP from a successful attack against them, you gain a Fear.'}]},
  {id:'outer-realms-corrupter',tier:4,name:'Outer Realms Corrupter',type:'support',dc:19,hp:4,st:3,maj:27,sev:47,atk:'+7',wpn:'Corroding Pseudopod · Very Close',dmg:'4d8+5 mag',motives:'Confuse, distract, overwhelm',feats:[{k:P,n:'Will-Shattering Touch',d:'When a PC takes damage from the Corrupter, they lose a Hope.'},{k:A,n:'Disgorge Reality Flotsam',d:'Mark a Stress to spew partially digested portions of consumed realities at all targets within Close range. Targets must succeed on a Knowledge Reaction Roll or mark 2 Stress.'}]},
  {id:'outer-realms-thrall',tier:4,name:'Outer Realms Thrall',type:'minion',dc:17,hp:1,st:1,maj:null,sev:null,atk:'+3',wpn:'Claws and Teeth · Very Close',dmg:'11 phy',motives:'Destroy, disgust, disorient, intimidate',feats:[{k:P,n:'Minion (13)',d:'The Thrall is defeated when they take any damage. For every 13 damage a PC deals to the Thrall, defeat an additional Minion within range the attack would succeed against.'},{k:A,n:'Group Attack',d:'Spend a Fear to choose a target and spotlight all Outer Realm Thralls within Close range of them. Those Minions move into Melee range and make one shared attack roll. On a success, they deal 11 physical damage each. Combine this damage.'}]},
  {id:'volcanic-dragon-obsidian-predator',tier:4,name:'Volcanic Dragon: Obsidian Predator',type:'solo',dc:19,hp:6,st:5,maj:33,sev:65,atk:'+8',wpn:'Obsidian Claws · Close',dmg:'4d10+4 phy',motives:'Defend lair, dive-bomb, fly, hunt, intimidate',feats:[{k:P,n:'Relentless (2)',d:'The Obsidian Predator can be spotlighted up to two times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Flying',d:'While flying, the Obsidian Predator gains a +3 bonus to their Difficulty.'},{k:P,n:'Obsidian Scales',d:'The Obsidian Predator is resistant to physical damage.'},{k:A,n:'Avalanche Tail',d:'Mark a Stress to make an attack against all targets within Close range. Targets the Obsidian Predator succeeds against take 4d6+4 physical damage and are knocked back to Far range and Vulnerable until their next roll with Hope.'},{k:A,n:'Dive-Bomb',d:'If the Obsidian Predator is flying, mark a Stress to choose a point within Far range. Move to that point and make an attack against all targets within Very Close range. Targets the Obsidian Predator succeeds against take 2d10+6 physical damage and must mark a Stress and lose a Hope.'},{k:R,n:'Erupting Rage',d:'Phase Change: When the Obsidian Predator marks their last HP, replace them with the Molten Scourge and immediately spotlight them.'}]},
  {id:'volcanic-dragon-molten-scourge',tier:4,name:'Volcanic Dragon: Molten Scourge',type:'solo',dc:20,hp:7,st:5,maj:30,sev:58,atk:'+9',wpn:'Lava-Coated Claws · Close',dmg:'4d12+4 phy',motives:'Douse with lava, incinerate, repel invaders, reposition',feats:[{k:P,n:'Relentless (3)',d:'The Molten Scourge can be spotlighted up to three times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Cracked Scales',d:'When the Molten Scourge takes damage, roll a number of d6s equal to HP marked. For each result of 4 or higher, you gain a Fear.'},{k:A,n:'Shattering Might',d:'Mark a Stress to make an attack against a target within Very Close range. On a success, the target takes 4d8+1 physical damage, loses a Hope, and is knocked back to Close range. The Molten Scourge clears a Stress.'},{k:A,n:'Eruption',d:"Spend a Fear to erupt lava from beneath the Molten Scourge's scales, filling the area within Very Close range with molten lava. All targets must succeed on an Agility Reaction Roll or take 4d6+6 physical damage and be knocked back to Close range. This area remains lava — when a creature other than the Molten Scourge enters or acts within it, they must mark 6 HP."},{k:R,n:'Volcanic Breath',d:'When the Molten Scourge takes Major damage, roll a d10. On a result of 8 or higher, the Molten Scourge breathes a flow of lava in front of them within Far range. Targets who fail an Agility Reaction Roll take 2d10+4 physical damage, mark 1d4 Stress, and are Vulnerable until they clear a Stress. Targets who succeed take half damage and must mark a Stress.'},{k:R,n:'Lava Splash',d:'When the Molten Scourge takes Severe damage from an attack within Very Close range, molten blood gushes from the wound and deals 2d10+4 direct physical damage to the attacker.'},{k:R,n:'Ashen Vengeance',d:'Phase Change: When the Molten Scourge marks their last HP, replace them with the Ashen Tyrant and immediately spotlight them.'}]},
  {id:'volcanic-dragon-ashen-tyrant',tier:4,name:'Volcanic Dragon: Ashen Tyrant',type:'solo',dc:18,hp:8,st:5,maj:29,sev:55,atk:'+10',wpn:'Claws and Teeth · Close',dmg:'4d12+15 phy',motives:'Choke, fly, intimidate, kill or be killed',feats:[{k:P,n:'Relentless (4)',d:'The Ashen Tyrant can be spotlighted up to four times per GM turn. Spend Fear as usual to spotlight them.'},{k:P,n:'Cornered',d:'Mark a Stress instead of spending a Fear to spotlight the Ashen Tyrant.'},{k:P,n:'Injured Wings',d:'While flying, the Ashen Tyrant gains a +1 bonus to their Difficulty.'},{k:P,n:'Ashes to Ashes',d:"When a PC rolls a failure while within Close range of the Ashen Tyrant, they lose a Hope and you gain a Fear. If the PC can't lose a Hope, they must mark a HP."},{k:A,n:'Desperate Rampage',d:'Mark a Stress to make an attack against all targets within Close range. Targets the Ashen Tyrant succeeds against take 2d20+2 physical damage, are knocked back, and must mark a Stress.'},{k:A,n:'Ashen Cloud',d:'Spend a Fear to smash the ground and kick up ash within Far range. While within the ash cloud, a target has disadvantage on action rolls. The ash cloud clears the next time an adversary is spotlighted.'},{k:A,n:'Apocalyptic Thrashing',d:'Countdown (1d12). Spend a Fear to activate. It ticks down when a PC rolls with Fear. When it triggers, the Ashen Tyrant thrashes about, causing environmental damage. All targets within Far range must make a Strength Reaction Roll. Targets who fail take 2d10+10 physical damage and are Restrained by rubble until they break free with a successful Strength Roll. Targets who succeed take half damage.'}]},
  {id:'perfected-zombie',tier:4,name:'Perfected Zombie',type:'bruiser',dc:20,hp:9,st:4,maj:40,sev:70,atk:'+4',wpn:'Greataxe · Very Close',dmg:'4d12+15 phy',motives:'Consume, hound, maim, terrify',feats:[{k:P,n:'Terrifying',d:'When the Zombie makes a successful attack, all PCs within Far range lose a Hope and you gain a Fear.'},{k:P,n:'Fearsome Presence',d:"PCs can't spend Hope to use features against the Zombie."},{k:A,n:'Perfect Strike',d:'Mark a Stress to make a standard attack against all targets within Very Close range. Targets the Zombie succeeds against are Vulnerable until their next rest.'},{k:R,n:'Skilled Opportunist',d:"When another adversary deals damage to a target within Very Close range of the Zombie, you can spend a Fear to add the Zombie's standard attack damage to the damage roll."}]},
  {id:'zombie-legion',tier:4,name:'Zombie Legion',type:'horde',dc:17,hp:8,st:5,maj:25,sev:45,atk:'+2',wpn:'Undead Hands · Close',dmg:'4d6+10 phy',motives:'Consume brain, shred flesh, surround',feats:[{k:P,n:'Horde (2d6+5)',d:'When the Legion has marked half or more of their HP, their standard attack deals 2d6+5 physical damage instead.'},{k:P,n:'Unyielding',d:'The Legion has resistance to physical damage.'},{k:P,n:'Relentless (2)',d:'The Legion can be spotlighted up to two times per GM turn. Spend Fear as usual to spotlight them.'},{k:R,n:'Overwhelm',d:'When the Legion takes Minor damage from an attack within Melee range, you can mark a Stress to make a standard attack with advantage against the attacker.'}]},
];
...
let cart=[],combatants=[],filterType='all',filterTier='all',filterSearch='',iid=0;
...
function buildFilters(){
  var tierOpts=['all',1,2,3,4].map(function(v){
    var sel=v===filterTier||String(v)===String(filterTier)?'selected':'';
    return '<option value="'+v+'" '+sel+'>'+(v==='all'?'All Tiers':'T'+v)+'</option>';
  }).join('');
  var typeOpts=['all',...TYPE_ORDER].map(function(t){
    var sel=t===filterType?'selected':'';
    return '<option value="'+t+'" '+sel+'>'+(t==='all'?'All Types':ICONS[t]+' '+cap(t))+'</option>';
  }).join('');
  document.getElementById('filter-row').innerHTML=
    '<div class="filter-dropdowns">'+
      '<div class="filter-col"><label class="filter-label">Tier</label>'+
        '<select class="filter-select" onchange="setTierFilter(this.value)">'+tierOpts+'</select></div>'+
      '<div class="filter-col"><label class="filter-label">Type</label>'+
        '<select class="filter-select" onchange="setFilter(this.value)">'+typeOpts+'</select></div>'+
    '</div>';
}
function setFilter(t){filterType=t;buildFilters();renderList();}
function setTierFilter(t){filterTier=t==='all'?'all':parseInt(t)||t;buildFilters();renderList();}
...
function loadSession(){
  ...
  try{
    ...
    if(state.filterTier!=null)filterTier=state.filterTier==='all'?'all':state.filterTier;
    if(state.filterType!=null)filterType=state.filterType||'all';
